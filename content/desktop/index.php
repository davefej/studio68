            ...
            <ul class="clearfix">
                <li>
                    <table class="teamtable">
                        <tr>
                            <td class="teamtd">
                                <img class="teamimg" src="res/img/zoli_profil.png"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="teamtd">
                ...
                <li>
                    <table class="teamtable">
                        <tr>
                            <td class="teamtd">
                                <img class="teamimg" src="res/img/andras_profil.png"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="teamtd">
                ...
                <li>
                    <table class="teamtable">
                        <tr>
                            <td class="teamtd">
                                <img class="teamimg" src="res/img/deni_profil.png"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="teamtd">
                ...
                <li>
                    <table class="teamtable">
                        <tr>
                            <td class="teamtd">
                                <img class="teamimg" src="res/img/reni_profil.png"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="teamtd">
                ...
                <li>
                    <table class="teamtable">
                        <tr>
                            <td class="teamtd">
                                <img class="teamimg" src="res/img/evi_profil.png"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="teamtd">
                ...
                <li>
                    <table class="teamtable">
                        <tr>
                            <td class="teamtd">
                                <img class="teamimg" src="res/img/robi_profil.png"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="teamtd">
                ...
                <li>
                    <table class="teamtable">
                        <tr>
                            <td class="teamtd">
                                <img class="teamimg" src="res/img/magdi_profil.png"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="teamtd">
