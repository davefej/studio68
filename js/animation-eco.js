function init() {
    ...
    window.addEventListener('scroll', function(e) {
        ...
        var department_height = document.getElementById("eco-main").clientHeight + main_height;
        var timeline_height = document.getElementById("eco-bio").clientHeight + department_height;
        team_height = timeline_height;
